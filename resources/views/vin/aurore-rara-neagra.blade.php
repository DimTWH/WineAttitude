@extends('app', ['page' => __('Aurore Rara Neagra')])
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="woocommerce-product-gallery woocommerce-product-gallery--with-images woocommerce-product-gallery--columns-4 images" data-columns="4" style="opacity: 1; transition: opacity 0.25s ease-in-out 0s;">
                                    <figure class="woocommerce-product-gallery__wrapper">
                                        <div data-thumb="{{  asset('pictures/cave/fautor/vin/aurore-bg.jpg')  }}" data-thumb-alt="" class="woocommerce-product-gallery__image">
                                            <a href="{{  asset('pictures/cave/fautor/vin/aurore-bg.jpg')  }}">
                                                <img src="{{  asset('pictures/cave/fautor/vin/aurore-bg.jpg')  }}" alt="" loading="lazy" title="Gitana - Lupi"
                                                     data-caption="" data-src="{{  asset('pictures/cave/fautor/vin/aurore-bg.jpg')  }}"
                                                     data-large_image="{{  asset('pictures/cave/fautor/vin/aurore-bg.jpg')  }}"
                                                     data-large_image_width="1033" data-large_image_height="1335"
                                                     srcset="{{  asset('pictures/cave/fautor/vin/aurore-bg.jpg')  }} 840w,
                                                     {{  asset('pictures/cave/fautor/vin/aurore-bg.jpg')  }} 189w,
                                                     {{  asset('pictures/cave/fautor/vin/aurore-bg.jpg')  }} 644w,
                                                     {{  asset('pictures/cave/fautor/vin/aurore-bg.jpg')  }} 768w"
                                                     sizes="(max-width: 840px) 100vw, 840px" width="1033" height="1335">
                                                     <img role="presentation" alt="" src="{{  asset('pictures/cave/tewa/vin/aurore-bg.jpg')  }}" id="zoom" style="position: absolute;
                            ...
                            <div class="col-md-6">
                                <div class="summary entry-summary">
                                    ...
                                    <h1 class="product_title entry-title">Fautor Aurore Rara Neagra</h1><div itemprop="description">
                                        <p>
                                            The rare elegance of Rara Neagra, from FAUTOR Winery, will amaze you with its unique bouquet in your mouth and your nose will not stop savoring it all evening. It is a pure autochthonous grape variety from the Moldavian region which inspires you to savor it again and again.
                                        </p>
                                    </div>
                                    <p class="price">
                                    ...
                                    <table class="shop_attributes">
                                        <tbody><tr class="woocommerce-product-attributes-item">
                                            ...
                                            <td class=""><p>Rara Neagra(Babeasca Neagra)</p>
                                            </td>
                                        </tr>
                                        <tr class="woocommerce-product-attributes-item">
                                            <th class="woocommerce-product-attributes-item__label">VINEYARDS</th>
                                            <td class="woocommerce-product-attributes-item__value"><p>Valul lui Traian</p>
                                            </td>
                                        </tr>
                                        <tr class="woocommerce-product-attributes-item">
                                ...
                                <div class="vc_column-inner vc_custom_1636230994456">
                                    <div class="wpb_wrapper">
                                        ...
                                        <div class="wpb_text_column wpb_content_element  vc_custom_1460727890422">
                                            <div class="wpb_wrapper">
                                                <p>
                                                    A heartwarming, delicious food wine made from the Moldovan and Romanian grape variety Rară Neagră. Dried cranberry, ripe dark cherries, tobacco leaves and a hint of smoke on the nose. Savory and rounded, with plenty of juicy plums and sour cherries to fill the peppery palate. Drooling acidity of the variety. The tannins are fine-grained but firm.
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="vc_column-inner vc_custom_1636231052207">
                                    <div class="wpb_wrapper">
                                        ...
                                        <div class="wpb_text_column wpb_content_element ">
                                            <div class="wpb_wrapper">
                                                <p>
                                                    Beef, game, charcuterie, pasta, roasted eggplant.
                                                </p>
