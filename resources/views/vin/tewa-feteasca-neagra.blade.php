@extends('app', ['page' => __('TeWa Feteasca Neagra')])
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="woocommerce-product-gallery woocommerce-product-gallery--with-images woocommerce-product-gallery--columns-4 images" data-columns="4" style="opacity: 1; transition: opacity 0.25s ease-in-out 0s;">
                                    <figure class="woocommerce-product-gallery__wrapper">
                                        <div data-thumb="{{  asset('pictures/cave/tewa/vin/tewa-raraneagra-nobg.png')  }}" data-thumb-alt="" class="woocommerce-product-gallery__image">
                                            <a href="{{  asset('pictures/cave/tewa/vin/tewa-raraneagra-nobg.png')  }}">
                                                <img src="{{  asset('pictures/cave/tewa/vin/tewa-raraneagra-nobg.png')  }}" class="wp-post-image" alt="" loading="lazy" title="Gitana - Lupi"
                                                     data-caption="" data-src="{{  asset('pictures/cave/tewa/vin/tewa-raraneagra-nobg.png')  }}"
                                                     data-large_image="{{  asset('pictures/cave/gitana/vin/lupi-nobg3.png')  }}"
                                                     data-large_image_width="1033" data-large_image_height="1335"
                                                     srcset="{{  asset('pictures/cave/tewa/vin/tewa-raraneagra-nobg.png')  }} 840w,
                                                     {{  asset('pictures/cave/tewa/vin/tewa-raraneagra-nobg.png')  }} 189w,
                                                     {{  asset('pictures/cave/tewa/vin/tewa-raraneagra-nobg.png')  }} 644w,
                                                     {{  asset('pictures/cave/tewa/vin/tewa-raraneagra-nobg.png')  }} 768w"
                            ...
                            <div class="col-md-6">
                                <div class="summary entry-summary">
                                    ...
                                    <h1 class="product_title entry-title">TeWa Feteasca Neagra</h1><div itemprop="description">
                                        <p>
                                    ...
                                    <table class="shop_attributes">
                                        ...
                                        <tr class="woocommerce-product-attributes-item">
                                            ...
                                            <td class="woocommerce-product-attributes-item__value">
                                                <p>Răscăieții Noi, Ștefan Vodă</p>
                                            </td>
                                        </tr>
                                        <tr class="woocommerce-product-attributes-item">
                                            <th class="woocommerce-product-attributes-item__label">
                                ...
                                <div class="vc_column-inner vc_custom_1636230994456">
                                    <div class="wpb_wrapper">
                                        ...
                                        <div class="wpb_text_column wpb_content_element  vc_custom_1460727890422">
                                            <div class="wpb_wrapper">
                                                <p>
                                                    Kleur met lage intensiteit, mooi robijnrood met amberkleurige tinten.
                                                    Medium uitgesproken aroma's van zoete specerijen, zwarte pruim, zwarte kers, sappige framboos, en gedroogde kruiden.
                                                    Een zeer verleidelijk bouquet dat ik gewoon wil blijven ruiken.
                                                    Medium-minus body, medium-minus zuurgraad, delicate fijnkorrelige tannines.
                                                    Een beetje slap, maar de tonen van pruim, framboos en zoete specerijen blijven hangen in de mond.
                                                    Een lange, aanhoudende afdronk.
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="vc_column-inner vc_custom_1636231052207">
                                    <div class="wpb_wrapper">
                                        ...
                                        <div class="wpb_text_column wpb_content_element ">
                                            <div class="wpb_wrapper">
                                                <p>
                                                    Ik zie deze specifieke fles Feteasca Neagra heel goed passen bij bao-broodjes met varkensvlees of pannenkoeken met pekingeend. Zou gemakkelijk lekker zijn bij geroosterd of gegrild vlees. Lam gyros of souvlaki met tzatziki misschien. Zelfs carne asada straat taco's zou lekker zijn met deze wijn. Dit is waarom Feteasca Neagra perfect is voor de zomer. Deze wijn past bij zowat alles wat op de zomerse grill ligt. 
                                                </p>
