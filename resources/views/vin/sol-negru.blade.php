                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="woocommerce-product-gallery woocommerce-product-gallery--with-images woocommerce-product-gallery--columns-4 images" data-columns="4" style="opacity: 1; transition: opacity 0.25s ease-in-out 0s;">
                                    <figure class="woocommerce-product-gallery__wrapper">
                                        <div data-thumb="{{  asset('pictures/cave/asconi/vin/sol-negru.jpg')  }}" data-thumb-alt="" class="woocommerce-product-gallery__image">
                                            <a href="{{  asset('pictures/cave/asconi/vin/sol-negru.jpg')  }}">
                                                <img src="{{  asset('pictures/cave/asconi/vin/sol-negru.jpg')  }}" class="wp-post-image" alt="" loading="lazy" title="Gitana - Lupi"
                                                     data-caption="" data-src="{{  asset('pictures/cave/asconi/vin/sol-negru.jpg')  }}"
                                                     data-large_image="{{  asset('pictures/cave/asconi/vin/sol-negru.jpg')  }}"
                                                     data-large_image_width="1033" data-large_image_height="1335"
                                                     srcset="{{  asset('pictures/cave/asconi/vin/sol-negru.jpg')  }} 840w,
                                                     {{  asset('pictures/cave/asconi/vin/sol-negru.jpg')  }} 189w,
                                                     {{  asset('pictures/cave/asconi/vin/sol-negru.jpg')  }} 644w,
                                                     {{  asset('pictures/cave/asconi/vin/sol-negru.jpg')  }} 768w"
                                                     sizes="(max-width: 840px) 100vw, 840px" width="1033" height="1335">
                                                     <img role="presentation" alt="" src="{{  asset('pictures/cave/asconi/vin/sol-negru.jpg')  }}" id="zoom" style="position: absolute;
                            ...
                            <div class="col-md-6">
                                <div class="summary entry-summary">
                                    ...
                                    <h1 class="product_title entry-title">ASCONI Sol Negru Cabernet Sauvignon</h1><div itemprop="description">
                                        <p>
                                            At a glance the 2021 Cabernet Sauvignon Rosé captures the essence of summer. With its peachy-gold huesit radiates charm, and promises a delicious and refreshing drop of wine. Fresh strawberries, raspberries and a subtle creamy note define the nose. The pallete is framed by beautifully balanced, succulent fruit flavors and a fine, mineral finish.
                                        </p>
                                    </div>
                                    ...
                                    <table class="shop_attributes">
                                        <tbody><tr class="woocommerce-product-attributes-item">
                                            ...
                                            <td class=""><p>100% Cabernet Sauvignon</p>
                                            </td>
                                        </tr>
                                        <tr class="woocommerce-product-attributes-item">
                                            <th class="woocommerce-product-attributes-item__label">Wine region</th>
                                            <td class="woocommerce-product-attributes-item__value"><p>Codru, PGI</p>
                                            </td>
                                        </tr>
                                        <tr class="woocommerce-product-attributes-item">
                                        ...
                                        <tr class="woocommerce-product-attributes-item">
                                            ...
                                            <td class="woocommerce-product-attributes-item__value"><p>dry, rosé</p>
                                            </td>
                                        </tr>
                                        <tr class="woocommerce-product-attributes-item">
                                ...
                                <div class="vc_column-inner vc_custom_1636230994456">
                                    <div class="wpb_wrapper">
                                        ...
                                        <div class="wpb_text_column wpb_content_element  vc_custom_1460727890422">
                                            <div class="wpb_wrapper">
                                                <p>
                                                    Fresh strawberries, raspberries and a subtle creamy note define the nose. The pallete is framed by beautifully balanced, succulent fruit flavors and a fine, mineral finish.
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="vc_column-inner vc_custom_1636231018665">
                                    <div class="wpb_wrapper">
                                        ...
                                        <div class="wpb_text_column wpb_content_element ">
                                            <div class="wpb_wrapper">
                                                <p>
                                                    The wine is contained in stainless steel tanks. It is fermented at 17 °C for about 18-23 days.
                                                </p>
                                ...
                                <div class="vc_column-inner vc_custom_1636231052207">
                                    <div class="wpb_wrapper">
                                        ...
                                        <div class="wpb_text_column wpb_content_element ">
                                            <div class="wpb_wrapper">
                                                <p>
                                                    Sol Negru goes well with chicken lasagna with white sauce and grilled dorada.
                                                </p>
