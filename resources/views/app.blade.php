            ...
            <div class="container-fluid">
                <div class="row align-items-center">
                    <div class="col-lg-2" style="display: inline-block;">
                        <div class="logo">
                            <a href="{{ route("accueil") }}"> <img src="{{  asset('pictures/logo-h.png')  }}" alt=""></a>
                        </div>
                    </div>
                    <div class="col-lg-6" style="display: inline-block;">
                        <div class="main_menu menu_two menu_position">
                            <nav>
                                <ul>
                                    <li>
                                        <a href="{{ route("accueil") }}" class="active">Home</a>
                                    </li>
                                    <li>
                                        <a href="#">Onze wijnen <i class="fa fa-angle-down"></i></a>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="section-footer col-md-3 col-sm-3">
                <div class="footer-block about">
                    <h4 class="footer-title">Onze wijnen</h4>
                    <hr class="footer_border">
                    <ul class="list-unstyled">
                        <li><a href="{{ route('lupi') }}">GITANA - Lupi</a></li>
                        <li><a href="{{ route('aurore-rara-neagra') }}">FAUTOR - Aurore Rara Neagra</a></li>
            ...
            <div class="section-footer col-md-3 col-sm-3" id="contact">
                <div class="footer-block about">
                    <h4 class="footer-title">Contacteer ons</h4>
                    <hr class="footer_border">
                    <ul class="list-unstyled">
            ...
            <div class="section-footer col-md-3 col-sm-3">
                <div class="footer-block about">
                    <h4 class="footer-title">Meer over ons</h4>
                    <hr class="footer_border">
                        <ul>
                            <li class="facebook">
                            ...
                            <li class="instagram">
                                <a href="https://www.instagram.com/wine.attitude.be/" target="_blank"><i class="fab fa-instagram"></i> wine.attitude.be</a>
                            </li>
                        </ul>
                    <br>
